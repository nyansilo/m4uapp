...
class PropertyGallery extends StatefulWidget {
  ...
  const PropertyGallery({Key? key, required this.property}) : super(key: key);

  @override
  _PropertyGalleryState createState() {
    return _PropertyGalleryState();
  }
}
...
class _PropertyGalleryState extends State<PropertyGallery> {
  ...
  PhotoViewGalleryPageOptions _buildItem(BuildContext context, int index) {
    final String item = widget.property.images![index].imgUrl!;
          ...
          children: <Widget>[
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    ...
                    child: CachedNetworkImage(
                      imageUrl: widget.property.images![index].imgUrl!,
            ...
            Padding(
              ...
              child: Row(
                ...
                children: <Widget>[
                  Text(
                    'Located at: ${widget.property.region!.name!}',
                  ...
                  Text(
                    "${_index + 1}/${widget.property.images!.length}",
                    style: Theme.of(context)
                        .textTheme
                        .subtitle2!
                        .copyWith(color: Colors.white),
            ...
            Container(
              ...
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  Border? border;
                  final item = widget.property.images![index];
                  if (index == _index) {
                    border = Border.all(
