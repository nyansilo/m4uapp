...
class _GalleryUploadState extends State<GalleryUpload> {
  ...
  void initState() {
    super.initState();
    _images = List<PropertyImageModel?>.from(widget.images);
  }
  ...
  ///On Update
  void _onUpdate(PropertyImageModel? old, PropertyImageModel item) {
    setState(() {
  ...
  void _onSave() {
    ...
    Navigator.pop(context, List<PropertyImageModel>.from(result));
  }
